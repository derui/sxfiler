...
let to_sort_fun = function
  | Types.Sort_type.Date ->
      fun v1 v2 -> Stdlib.compare v1.File_item.stat.mtime v2.File_item.stat.mtime
  | Types.Sort_type.Name ->
      fun v1 v2 ->
        Stdlib.compare (Path.basename v1.File_item.full_path) (Path.basename v2.File_item.full_path)
  | Types.Sort_type.Size ->
      fun v1 v2 -> Stdlib.compare v1.File_item.stat.size v2.File_item.stat.size
