...
module type S = sig
  ...
  (** [replicate ?new_name ~node ~_to ()] replicate [node] to the location [_to]. When [new_name]
      gives to this function, replicate as [new_name] to the location. If [new_name] not given and
