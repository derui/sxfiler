...
let build_command_aliases ~ppf static_commands dynamic_commands =
  List.iter
    (fun command -> build_command_alias ~command ~prefix:static_prefix ~ppf)
    static_commands ;
  List.iter
