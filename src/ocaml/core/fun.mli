...
(** [bracket ~setup ~teardown f] get data from [setup] and run [f] with it, and finalize [teardown] always. if [f] raise
    exception, do finalize and re-raise it. *)
...
(** [pipe f g] compose [f] and [g] that same flow of [\|\>] as [g (f v)]. *)

val compose : ('a -> 'b) -> ('c -> 'a) -> 'c -> 'b
(** [compose f g] compose [f] and [g] that same flow [f (g v)]. *)
