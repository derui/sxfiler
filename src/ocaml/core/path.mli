(** Pathname is utility module more flexibility handling path and filename based on {!Filename}
    module. This module allows to handle pathname on windows and *nix platform do not change
    codebase. *)
...
(** [basename path] gets the base name of [path]. If [path] is directory, this function returns
    empty string. *)
