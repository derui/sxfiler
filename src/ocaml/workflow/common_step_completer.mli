...
val read :
  ...
  S.t
(** signature to get candidates from collection with input. Implementation for step [read]. Notice that this step caches
    collection provided dependency function, so need to recreate step when collection is updated *)
