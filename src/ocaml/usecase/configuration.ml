...
module type Get =
  Common.Usecase with type input = unit and type output = T.Configuration.t and type error = unit
...
module type Store =
  Common.Usecase with type input = T.Configuration.t and type output = unit and type error = unit
