...
module type Get =
  Common.Usecase with type input = unit and type output = string Key_map.t and type error = unit
...
module type Store =
  Common.Usecase with type input = string Key_map.t and type output = unit and type error = unit
...
module type Enable_context =
  Common.Usecase with type input = Type.input and type output = Type.output and type error = unit
