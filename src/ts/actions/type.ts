...
export enum ActionTypes {
  ...
  BOOKMARK_REGISTER = "BOOKMARK_REGISTER",
  BOOKMARK_DELETE = "BOOKMARK_DELETE",
  BOOKMARK_UPDATE = "BOOKMARK_UPDATE",

  COMPLETER_OPEN = "COMPLETER_OPEN",
  COMPLETER_CURSOR_UP = "COMPLETER_CURSOR_UP",
  COMPLETER_CURSOR_DOWN = "COMPLETER_CURSOR_DOWN",
  COMPLETER_REPLACE_CANDIDATES = "COMPLETER_REPLACE_CANDIDATES",
  COMPLETER_CLOSE = "COMPLETER_CLOSE",
}
