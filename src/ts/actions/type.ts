...
export enum ActionTypes {
  COMPLETION_CURSOR_UP = "COMPLETION_CURSOR_UP",
  COMPLETION_CURSOR_DOWN = "COMPLETION_CURSOR_DOWN",
  COMPLETION_INITIALIZE = "COMPLETION_INITIALIZE_CANDIDATE",
  COMPLETION_READ = "COMPLETION_READ_CANDIDATES",
