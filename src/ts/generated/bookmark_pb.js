...
goog.exportSymbol('proto.BookmarkList', null, global);
 ...
 * @constructor
 */
proto.BookmarkList = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.BookmarkList.repeatedFields_, null);
};
goog.inherits(proto.BookmarkList, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.BookmarkList.displayName = 'proto.BookmarkList';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {string}
 */
proto.Bookmark.prototype.getName = function() {
...
/**
 * @param {string} value
 * @return {!proto.Bookmark} returns this
 */
proto.Bookmark.prototype.setName = function(value) {
 ...
 * @const
 */
proto.BookmarkList.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.BookmarkList.prototype.toObject = function(opt_includeInstance) {
  return proto.BookmarkList.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.BookmarkList} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.BookmarkList.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.BookmarkList}
 */
proto.BookmarkList.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.BookmarkList;
  return proto.BookmarkList.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.BookmarkList} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.BookmarkList}
 */
proto.BookmarkList.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.BookmarkList.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.BookmarkList.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.BookmarkList} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.BookmarkList.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 */
proto.BookmarkList.prototype.getItemsList = function() {
 ...
 * @return {!proto.BookmarkList} returns this
*/
proto.BookmarkList.prototype.setItemsList = function(value) {
 ...
 * @return {!proto.Bookmark}
 */
proto.BookmarkList.prototype.addItems = function(opt_value, opt_index) {
 ...
 * @return {!proto.BookmarkList} returns this
 */
proto.BookmarkList.prototype.clearItemsList = function() {
...
proto.ListAllResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    bookmarks: (f = msg.getBookmarks()) && proto.BookmarkList.toObject(includeInstance, f)
  };
...
proto.ListAllResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.BookmarkList;
      reader.readMessage(value,proto.BookmarkList.deserializeBinaryFromReader);
...
proto.ListAllResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getBookmarks();
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.BookmarkList.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional BookmarkList bookmarks = 1;
 * @return {?proto.BookmarkList}
 */
proto.ListAllResponse.prototype.getBookmarks = function() {
  return /** @type{?proto.BookmarkList} */ (
    jspb.Message.getWrapperField(this, proto.BookmarkList, 1));
};


/**
 * @param {?proto.BookmarkList|undefined} value
 * @return {!proto.ListAllResponse} returns this
*/
proto.ListAllResponse.prototype.setBookmarks = function(value) {
 ...
 * @return {!proto.ListAllResponse} returns this
 */
proto.ListAllResponse.prototype.clearBookmarks = function() {
  return this.setBookmarks(undefined);
};
 ...
 * @return {boolean}
 */
proto.ListAllResponse.prototype.hasBookmarks = function() {
...
proto.DeleteResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    deletedBookmarks: (f = msg.getDeletedBookmarks()) && proto.Bookmark.toObject(includeInstance, f)
  };
...
/**
 * optional Bookmark deleted_bookmarks = 1;
 * @return {?proto.Bookmark}
 */
proto.DeleteResponse.prototype.getDeletedBookmarks = function() {
  return /** @type{?proto.Bookmark} */ (
    jspb.Message.getWrapperField(this, proto.Bookmark, 1));
};
...
*/
proto.DeleteResponse.prototype.setDeletedBookmarks = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.DeleteResponse} returns this
 */
proto.DeleteResponse.prototype.clearDeletedBookmarks = function() {
  return this.setDeletedBookmarks(undefined);
};
 ...
 * @return {boolean}
 */
proto.DeleteResponse.prototype.hasDeletedBookmarks = function() {
  return jspb.Message.getField(this, 1) != null;
};
