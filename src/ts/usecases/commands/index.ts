...
export const registAllCommand = (registrar: CommandRegistrar): CommandRegistrar => {
  const modules = [filerChangePaneSide,filerEnterDirectory,filerMoveCursorDown,filerMoveCursorUp,filerMoveItems,filerMoveParent,filerToggleMark,keymapReload,taskSelectNextReply,taskSelectPreviousReply];
