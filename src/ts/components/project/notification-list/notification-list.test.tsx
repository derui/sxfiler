...
describe("Project", () => {
  describe("Notification List", () => {
    it("can render correctly", () => {
      ...
      const tree = renderer
        .create(<T notifications={notifications} timeouted={[]} onNotificationHidden={handle} />)
        .toJSON();
    ...
    it("can render with empty list of notification", () => {
      ...
      const tree = renderer.create(<T notifications={[]} timeouted={[]} onNotificationHidden={handle} />).toJSON();
    ...
    it("should set timeout specified", () => {
      ...
      const tree = renderer
        .create(<T notifications={notifications} timeouted={["id"]} onNotificationHidden={handle} />)
        .toJSON();
