...
let test_set =
  ...
  in
  let module M = I.Item_replication_service.Make (Dummy_ns) (Message_factory) (Progress_factory) in
  [
    Alcotest_lwt.test_case "replicate a item to destination" `Quick (fun _ () ->
